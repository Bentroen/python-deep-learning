...
if __name__ == "__main__":
    print("Running SOM.py as main script. Testing SOM.")
    # Set the seed value
    seed_value = 42
    ...
    som = SOM(m=5, n=5, dim=3, lr=0.5, sigma=1.0, max_iter=1000, random_state=42)

    # Fit the SOM to the input dataset
    som.fit(X)

    # Predict the cluster labels for the input dataset
    labels = som.predict(X)

    # Transform the input dataset into cluster distance space
    ...
    # Print the inertia
    print("Inertia:", som.inertia_)

    # Print the number of iterations
    print("Number of Iterations:", som.n_iter_)
